...
function setup() {
  ...
  rope1=new Rope(bobObject1.body,{x:280,y:50});
  rope2=new Rope(bobObject2.body,{x:330,y:50});
  rope3=new Rope(bobObject3.body,{x:380,y:50});
  rope4=new Rope(bobObject4.body,{x:430,y:50});
  rope5=new Rope(bobObject5.body,{x:480,y:50});
